...
export const api = {
  auth: {
    ...
    register: (data: { email: string; password: string; firstName: string; lastName: string; role?: string; phone?: string; referralCode?: string }) => client.post('/auth/register', data).then(r => r.data),
  },
  analytics: {
